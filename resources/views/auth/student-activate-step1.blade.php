...
<head>
    ...
    <title>Activate Account (Step 1) — Computing Society QR Attendance</title>
...
<div class="w-full max-w-md animate-slide-up">
    <div class="text-center mb-8">
        ...
        <p class="text-slate-400 mt-1 text-xs sm:text-sm">Step 1 of 4 — Verify Student Identity</p>
    </div>

    <div class="card shadow-xl border border-slate-800/80 bg-[#171a23]">
        <h2 class="font-brand-display text-base font-bold text-white mb-2">Enter Your Student Number</h2>
        <p class="text-slate-400 text-xs mb-6">Enter your official Student Number to verify that you are listed in the society masterlist.</p>
        ...
        <form method="POST" action="{{ route('student.activate.student.submit') }}" class="space-y-4">
            @csrf
