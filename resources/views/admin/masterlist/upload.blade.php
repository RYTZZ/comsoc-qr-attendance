    ...
    <div class="card mb-6">
        <div class="alert-info mb-5">
            ...
            <div>
                ...
                <p class="text-xs opacity-80">Required columns: <strong>Student Number</strong>, <strong>Name</strong> (or Last Name, First Name, Middle Name), and <strong>Year Level</strong> (1st Year, 2nd Year, 3rd Year, 4th Year). Optional: <strong>Program</strong>. Excel (.xlsx, .xls) and CSV are accepted. Maximum file size: 10MB.</p>
            </div>
        </div>
